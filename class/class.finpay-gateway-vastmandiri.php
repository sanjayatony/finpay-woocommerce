<?php
/**
 * vastmandiri / Felisa Permata Open
 */

class WC_Gateway_Finpay_Vastmandiri extends WC_Payment_Gateway {

	/**
	 * constructor
	 */
	private $sof_id   = 'vastmandiri';
	private $sof_desc = 'Mandiri Virtual Account - Open Payment';

	public function __construct() {
		$this->id                 = $this->sof_id;
		$this->has_fields         = false;
		$this->method_title       = 'Mandiri Virtual Account - Open Payment';
		$this->method_description = 'Allows payments using Mandiri Virtual Account - Open Payment';
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'                 => array(
				...
				'type'    => 'checkbox',
				'label'   => 'Enable Mandiri Virtual Account - Open Payment',
				'default' => 'no',
			),
			'title'                   => array(
				...
				'default'     => 'Mandiri Virtual Account - Open Payment',
				'desc_tip'    => true,
			),
			'description'             => array(
