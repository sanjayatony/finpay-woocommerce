...
class WC_Gateway_Finpay_Briva extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = 'BRI Virtual Account - Close Payment';
		$this->method_description = 'Allows payments using BRI Virtual Account - Close Payment';
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'                 => array(
				...
				'type'    => 'checkbox',
				'label'   => 'EnableBRI Virtual Account - Close Payments ',
				'default' => 'no',
			),
			'title'                   => array(
				...
				'default'     => 'BRI Virtual Account - Close Payment',
				'desc_tip'    => true,
			),
			'description'             => array(
