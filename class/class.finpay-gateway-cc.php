...
class WC_Gateway_Finpay_Cc extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = 'Allows payments using Credit Card';
		$this->icon               = plugins_url( 'img/cc.png', dirname( __FILE__ ) );
	...
	public function generate_request( $order_id ) {
		...
		$invoice     = $order->get_order_number(); // need plugin
	...
	public function thankyou_page( $order_id ) {
		echo esc_htm( wptexturize( $this->instructions ) );
	}
	/**
