<?php
/**
 * vastbni / Felisa BNI Open
 */

class WC_Gateway_Finpay_Vastbni extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = 'BNI Virtual Account - Open Payment';
		$this->method_description = 'Allows payments using BNI Virtual Account - Open Payment';
		$this->icon               = plugins_url( 'img/bni.png', dirname( __FILE__ ) );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'                 => array(
				...
				'type'    => 'checkbox',
				'label'   => 'Enable BNI Virtual Account - Open Payment',
				'default' => 'no',
			),
			'title'                   => array(
				...
				'default'     => 'BNI Virtual Account - Open Payment',
				'desc_tip'    => true,
			),
			'description'             => array(
