<?php
/**
 * vastpermata / Felisa Permata Open
 */

class WC_Gateway_Finpay_Vastpermata extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = 'Permata Virtual Account - Open Payment';
		$this->method_description = 'Allows payments using Permata Virtual Account - Open Payment';
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'                 => array(
				...
				'type'    => 'checkbox',
				'label'   => 'Enable Permata Virtual Account - Open Payment',
				'default' => 'no',
			),
			'title'                   => array(
				...
				'default'     => 'Permata Virtual Account - Open Payment',
				'desc_tip'    => true,
			),
			'description'             => array(
